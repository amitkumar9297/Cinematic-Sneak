  ...
  useEffect(() => {
    const fetchingData = async () => {
      try {
        ...
        const adventureResponse = await axios.get(
        ...
        const documentaryResponse = await axios.get(
          `${baseUrl}/discover/movie?api_key=${apiKey}&with_genres=99`
        );
        const scienceFictionResponse = await axios.get(
